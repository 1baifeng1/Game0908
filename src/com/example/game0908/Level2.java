...
public class Level2 extends Activity {
	...
	private void handleOK() {
		...
		new AlertDialog.Builder(Level2.this)
				...
				.setPositiveButton("让我们再来一遍",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								finish();
								Intent intentLevel2 = new Intent();
								intentLevel2.setClass(getApplicationContext(),
										Level2.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		game2 = (MyView2) findViewById(R.id.game2);
	...
	boolean isOK() {
		for (int i = 0; i < 8; i++) {
			if (MyView2.bean[i])// 还有豆子
				return false;
		}
		return Chongzi2.posi[0][0] == MyView2.x
				&& Chongzi2.posi[0][1] == MyView2.y;
	}
