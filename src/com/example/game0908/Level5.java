...
public class Level5 extends Activity {
				...
				.setPositiveButton("让我们再来一遍",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								finish();
								Intent intentLevel5 = new Intent();
								intentLevel5.setClass(getApplicationContext(),
										Level5.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		game5 = (MyView5) findViewById(R.id.game5);
		/** 开始与停止按钮 **/
	 ...
	 */
	boolean isOK() {
		for (int i = 0; i < MyView5.bean.length; i++) {
			if (MyView5.bean[i])// 还有豆子
				return false;
		}
		return Chongzi5.posi[0][0] == MyView5.x
				&& Chongzi5.posi[0][1] == MyView5.y;
	}
