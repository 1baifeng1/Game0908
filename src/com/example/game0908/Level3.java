...
public class Level3 extends Activity {
	...
	private void handleOK() {
		...
		new AlertDialog.Builder(Level3.this)
				// 这儿用getApplicationContext（）会崩溃
				.setMessage("恭喜你，成功完成了第三关。")
				...
				.setPositiveButton("让我们再来一遍",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								finish();
								Intent intentLevel3 = new Intent();
								intentLevel3.setClass(getApplicationContext(),
										Level3.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		game3 = (MyView3) findViewById(R.id.game3);
		/** 开始与停止按钮 **/
	...
	boolean isOK() {
		for (int i = 0; i < 5; i++) {
			if (MyView3.bean[i])// 还有豆子
				return false;
		}
		return Chongzi3.posi[0][0] == MyView3.x
				&& Chongzi3.posi[0][1] == MyView3.y;
	}
